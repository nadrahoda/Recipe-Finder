...
const Home = ({ setDiet,cuisine,setCuisine,diet,recipes, setRecipes,recipeId, query, setQuery, healthLabels, setHealthLabels, getRecipes, setRecipeId }) => {
  ...
  return (
    <div className="app">
      ...
      <form className="searchbox" onSubmit={handleSubmit}>
        ...
        <h3 className="text-[#ff9a33] text-lg font-semibold mt-4 flex justify-center">Select any filter:</h3>
  ...
  <option value="Vietnamese">Vietnamese</option>
      ...
      <div className="recipe-grid flex justify-between" style={{ display: 'grid', gap: '4rem', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))' }}>
