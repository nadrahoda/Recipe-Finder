...
const Homepage = ({ recipe,setRecipeId,recipeId }) => {
  ...
  <p className="text-center pr-6">Serving</p>
              ...
              <hr/>
              <div onClick={()=>{localStorage.setItem('RECIPE_NAME',recipe.id)}} className="w-full flex justify-center items-center rounded-b-lg py-3 bg-orange-500">
                <button className="text-white font-medium text-base">   <Link to="/recipe" >
