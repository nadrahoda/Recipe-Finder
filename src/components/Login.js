        ...
        <div className='flex flex-col justify-center items-center my-10'>
          <h2 className='font-bold text-2xl mb-6'>Log In</h2>
            ...
            <div className='flex justify-center items-center mt-6'>
              <button onClick={()=>login()} className='btn bg-[#ff9a33] text-white px-8 py-2 rounded-full w-full'>Log In</button>
            </div>
            <p className='mt-5 text-base'>Already have an account?<span className='text-[#ff9a33] underline cursor-pointer ml-3'><Link to='/signup' className=''>
            Sign Up      </Link>    </span></p>
